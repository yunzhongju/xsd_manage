			  		...
			  		<el-form-item 
						...
						<el-form-item
							...
							<el-input 
								style="width: 544px;" 
								type="textarea"
								v-model="ruleForm.resume" ></el-input>
						</el-form-item>
			  		<el-form-item 
							label="内容详情" 
							prop="content">
						...
						<el-form-item>
			  			<el-button 
								...
								:disabled="isAudit=='1'">发布</el-button>
...
export default {
	...
	data() {
		return {
			...
			qiniuaddr: 'http://xsdwm.quweiquwei.com/', //图片外接地址
			img_url: '', //预览图片url
			dialogImageUrl: '', 
	...
	methods: {
		...
		submitForm(formName) {
			...
			let region=this.ruleForm.region?this.ruleForm.region:[]
			let p={
				...
				tags:this.handleTags(this.ruleForm.tags)?this.handleTags(this.ruleForm.tags):'',
